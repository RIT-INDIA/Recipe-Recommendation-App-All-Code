...
public class StudentAdapter extends RecyclerView.Adapter<com.example.myrecipe.adapter.StudentAdapter.ViewHolder> implements Filterable {
    ...
    public com.example.myrecipe.adapter.StudentAdapter.ingredientsDataFilter ingredientsDataFilter;
    ...
    public Filter getFilter() {
        ...
        if (ingredientsDataFilter == null) {
            ingredientsDataFilter = new com.example.myrecipe.adapter.StudentAdapter.ingredientsDataFilter(ingredientsListTemp,this);
        }
    ...
    private class ingredientsDataFilter extends Filter {    //custom filter
        ...
        com.example.myrecipe.adapter.StudentAdapter adapter;
        public List<StudentModel> ingredientsListTemp;

        public ingredientsDataFilter(List<StudentModel> ingredientsListTemp, com.example.myrecipe.adapter.StudentAdapter adapter)
        {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView recycler_image_view;
        ...
        public ViewHolder(View view) {
            ...
            recycler_image_view = (ImageView) view.findViewById(R.id.recycler_image_view);
        }
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (studentList != null) {
            ...
            Glide.with(context).load(studentList.get(position).getImage()).placeholder(R.drawable.vegetable).into(holder.recycler_image_view);
